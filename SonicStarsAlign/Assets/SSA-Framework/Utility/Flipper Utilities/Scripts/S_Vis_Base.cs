...
public class S_Vis_Base : MonoBehaviour, ICustomEditorLogic
{
        ...
        [DrawOthersIf(false, new string[] {"_drawAtAllTimes", "_drawIfParentSelected", "_normalOutlineColour", "_selectedOutlineColour", "_normalFillColour", "_selectedFillColour", "_maxDistanceFromCameraToDraw" }, true)]
        [SerializeField]
        ...
        [HideInInspector]
        public Color _normalFillColour = new Color(1,1,1,0.0f);
        [HideInInspector]
        public Color _selectedFillColour = new Color(1,1,1,0.1f);

        [HideInInspector]
        public float _maxDistanceFromCameraToDraw = 1200;
        ...
        private void OnDrawGizmos () {
                ...
                if (S_S_Editor.IsTooFarFromEditorCamera(transform, _maxDistanceFromCameraToDraw)) { return; }
